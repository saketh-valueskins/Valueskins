...
export default function SettingsHub() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: T.bg, color: T.text, fontFamily: FONT, padding: '32px 20px' }}>
      <div style={{ maxWidth: '1180px', margin: '0 auto', display: 'grid', gridTemplateColumns: '236px 1fr', gap: '56px', alignItems: 'start' }}>
...
function LinkRow({ href, label, sub }: { href: string; label: string; sub: string }) {
  return (
    <Link href={href} style={{ ...rowStyle, textDecoration: 'none', color: T.text, borderRadius: '8px' }}>
      <div>
